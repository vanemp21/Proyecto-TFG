...
<title>Contacto</title>
   ...
   <main>
    <!--Esto son los datos inventados del restaurante-->
    <div class="contacto-contenido">
    <div id="contacto">
      <div id="titulosIndex">Contáctanos</div>
      <!--Imagen para adornar la página-->
        <div id="imagenAdorno">
        <img src="../imagenes/adorno.png">
        </div>
        <br>
      <div id="textosDireccion">
        <div id="contactoWhatsap">
          <b>Whatsapp:</b> 123-456-789
        </div>

        <div id="contactoCorreo">
          <b>Correo:</b> 1234@gmail.es
        </div>

      <div id="contactoDireccion">
          <b>Dirección:</b> Calle micalle nº1 - Córdoba<br><br>
      </div>
    </div>
    <!--Imagen para adornar la página-->
    <div id="imagenAdorno">
    ...
    <!--Este es el iframe para que aparezca el mapa de google, redirecciona al instituto-->
  <div id="ubicacionMapa">
    <iframe src="https://www.google.com/maps/embed?pb=!1m13!1m8!1m3!1d3133.132479547021!2d-0.8035733048652347!3d38.25323337209411!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMzjCsDE1JzEyLjMiTiAwwrA0OCcwNy41Ilc!5e0!3m2!1ses!2sus!4v1684541154604!5m2!1ses!2sus" width="300" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>
    <ul>
     <li>
     ...
     <li>
       <a class="twitter" href="www.twitter.es">
         <span></span>
         <span></span>
         <span></span>
         <span></span>
      ...
      <li>
       <a class="instagram" href="www.instagram.com">
         <span></span>
         <span></span>
         <span></span>
         <span></span>
     ...
     <li>
      <a class="google" href="www.google.es">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
